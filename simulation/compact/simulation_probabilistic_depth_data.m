...
fname = [];
laser_type = 'red';
data_folder = sprintf('../../data/experiment_9aug2017/pileup/far_%s_power_1.76', laser_type);
%data_folder = sprintf('../../data/experiment_9aug2017/pileup/kai_%s', laser_type);
...
I = 20.0; %120;
fprintf('\n##### Running ND filter with density %2.2f #####\n\n', nd_filters(target_ll) )
