function [] = simulation_depth_2D_independent()
...
%fn = 'motorcycle_GaussianPSF_40.0_noalbedo';
%fn = 'motorcycle_PicoquantBluePSF_40.0';
%fn = 'motorcycle_PicoquantBluePSF_40.0_noalbedo';
...
%Save result
fres = sprintf('%s.mat',fn);
save(fres, 'zv', 'av', 'log_mean_naive', 'log_max_naive', 'gaussmean_rc', 'gaussint_rc', 'gaussmean_naive', 'gaussint_naive', 'log_mean_rc', 'log_max_rc');
