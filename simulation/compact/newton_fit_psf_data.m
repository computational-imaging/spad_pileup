...
function test_psf_fit_data()
    ...
    %Experimentfolder 
    exp_folder = '../../data/experiment_9aug2017/pileup/near_blue_power_4.1';
   ...
   % nd_filters = [0.001];
    ...
    psf = psf(rmatched-1000:rmatched+1000);
    ...
    if smooth
        ...
        %Smooth
        psf_smooth = sgolayfilt(psf, 5, 13);
    ...
    save(sprintf('%s/psf_model%s_0.01_nomin.mat',exp_folder, smooth_ext), 'gmc');
