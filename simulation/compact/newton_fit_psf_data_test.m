...
function test_psf_fit_data()
    ...
    %Experimentfolder 
    exp_folder = '../../data/experiment_9aug2017/pileup/far_blue_power_3.9';
    %exp_folder = '../../data/experiment_9aug2017/pileup/kai_blue';
    ...
    for ii = 1:length(nd_filters)
        fname{ii} = sprintf('%s/blue_diff_%.01f_sec_%.01f.mat',exp_folder,nd_filters(ii)*100, acq_time(ii)/1000);
    end
